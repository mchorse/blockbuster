    ...
    public void processMethod(String name, MethodNode method)
    {
        ...
        while (it.hasNext())
        {
            ...
            if (i == 2)
            {
                ...
                String desc = CoreClassTransformer.get("(Laid;Lcm;Lars;I)V", "(Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/block/state/IBlockState;I)V");
